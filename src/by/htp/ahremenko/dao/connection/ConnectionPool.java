package by.htp.ahremenko.dao.connection;
...
public final class ConnectionPool {
	...
	public void initPoolData() throws ConnectionPoolException {
		...
		try {
			...
			givenAwayConQueue = new ArrayBlockingQueue<Connection>(this.poolSize);
			connectionQueue = new ArrayBlockingQueue<Connection>(this.poolSize);
